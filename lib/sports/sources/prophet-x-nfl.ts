// Prediction Market — ProphetX NFL (peer-to-peer). Same shape as NBA;
...
export async function fetchNflPredictionSnapshots(opts: {
  signal?: AbortSignal
  ...
  try {
    const res = await fetch(`${BASE}/markets/nfl`, {
