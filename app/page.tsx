...
const LandingTicker = dynamic(() => import('./_components/landing-ticker'), {
  ssr: false,
  loading: () => null,
})
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-14 sm:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 lg:gap-12 items-end">
            ...
            <div className="flex flex-col gap-3 lg:min-w-[260px]">
              ...
              >
                <div className="font-mono text-[10px] tracking-[0.32em] uppercase text-black/70">see what&rsquo;s in the pass</div>
                ...
                <div className="mt-3 flex items-center justify-between">
                  <span className="font-mono text-[10px] tracking-[0.32em] uppercase text-black/70">→ continue</span>
